      ...
      <div className="search-modal-card" onClick={(e) => e.stopPropagation()}>
        <div className="search-header">
          <div className="search-input-wrapper">
            ...
            <input
              type="text"
              placeholder="Search your posts and messages..."
              value={query}
        ...
        <div className="search-meta-bar">
          <span className="zk-search-badge">
            ...
            Search runs only on your device — nothing is sent to the server
          </span>
        ...
        <div className="search-results-list">
          {!query.trim() ? (
            <div className="search-empty">
              ...
              <p>Type to search through your decrypted posts and messages.</p>
            </div>
          ) : results.length === 0 ? (
            <div className="search-empty">
                ...
                <div className="hit-type-badge">
                  {hit.type === 'post' ? (
                    ...
                    <>
                      ...
                      <span>Message: <strong>{hit.sender} → {hit.recipient}</strong></span>
                    </>
                  )}
