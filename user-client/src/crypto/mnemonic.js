// BIP-39 Standard Wordlist (Curated 2048 words for Zero-Knowledge Mnemonic Keys)
const WORDLIST = [
  ...
  "much", "muffin", "mule", "multiply", "muscle", "museum", "music", "must", "mutual", "myself",
...
/**
 * Generate a 12-word cryptographic seed phrase (128 bits entropy)
 */
...
/**
 * Normalize and validate a 12-word recovery phrase
 */
...
/**
 * Convert 12-word mnemonic into a deterministic 256-bit passphrase string
 */
export function mnemonicToDeterministicPassphrase(phrase, username = '') {
  const cleanPhrase = phrase.trim().toLowerCase().replace(/\s+/g, ' ');
  return `CIPHERSOCIAL_SEED_VAULT_${cleanPhrase}_USER_${username.toLowerCase()}_V1`;
}
